...
st.markdown("""
<div style="background: linear-gradient(135deg, #1E2128 0%, #2A2D3A 100%); border-radius: 12px; padding: 1.5rem; margin: 1rem 0; border-left: 4px solid #1E88E5; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3); font-family: 'Inter', sans-serif;">
    <h3 style="color: #00ACC1; margin-top: 0; margin-bottom: 1rem; font-weight: 600;">🎯 ¿Qué es un ticker?</h3>
    <p style="color: #E0E0E0; line-height: 1.8; margin-bottom: 1rem;">Un <strong style="color: #1E88E5; font-weight: 600;">ticker</strong> es el código con el que se identifica una acción en la bolsa de valores. Cada empresa cotizada tiene un ticker único que permite acceder a su información de mercado.</p>
    <p style="color: #E0E0E0; line-height: 1.8; margin-bottom: 0.5rem;"><strong style="color: #1E88E5; font-weight: 600;">Ejemplos comunes:</strong></p>
    <ul style="color: #E0E0E0; line-height: 1.8; margin-left: 1.5rem; list-style-type: disc;">
        <li style="color: #E0E0E0; margin-bottom: 0.5rem;"><strong style="color: #1E88E5; font-weight: 600;">AAPL</strong> → Apple Inc.</li>
        <li style="color: #E0E0E0; margin-bottom: 0.5rem;"><strong style="color: #1E88E5; font-weight: 600;">MSFT</strong> → Microsoft Corporation</li>
        <li style="color: #E0E0E0; margin-bottom: 0.5rem;"><strong style="color: #1E88E5; font-weight: 600;">GOOGL</strong> → Alphabet (Google)</li>
    </ul>
    <p style="color: #E0E0E0; line-height: 1.8; margin-bottom: 0;">Estos códigos se utilizan para descargar automáticamente los precios históricos y realizar el análisis financiero del portafolio.</p>
</div>
...
if st.session_state.run_analysis and not st.session_state.analysis_done:
        ...
        try:
            ...
            **¿La optimización realmente mejora los resultados frente a alternativas simples y ampliamente utilizadas?**
            ...
            st.markdown("""
<div style="background: linear-gradient(135deg, #1E2128 0%, #2A2D3A 100%); border-radius: 12px; padding: 1.5rem; margin: 1rem 0; border-left: 4px solid #1E88E5; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3); font-family: 'Inter', sans-serif;">
    <p style="color: #E0E0E0; line-height: 1.8; margin-bottom: 1rem; font-weight: 600;"><strong style="color: #1E88E5;">Cómo interpretar la gráfica de rendimiento acumulado</strong></p>
    <p style="color: #E0E0E0; line-height: 1.8; margin-bottom: 1rem;">Esta gráfica muestra cómo habría evolucionado una inversión inicial a lo largo del tiempo bajo cada estrategia.</p>
    <ul style="color: #E0E0E0; line-height: 1.8; margin-left: 1.5rem; list-style-type: disc;">
        <li style="color: #E0E0E0; margin-bottom: 0.5rem;">La línea que termina <strong style="color: #1E88E5;">más arriba</strong> representa la estrategia con <strong style="color: #1E88E5;">mayor crecimiento acumulado</strong>.</li>
        <li style="color: #E0E0E0; margin-bottom: 0.5rem;">Las curvas más <strong style="color: #1E88E5;">suaves y estables</strong> indican menor volatilidad y menor exposición a crisis.</li>
        <li style="color: #E0E0E0; margin-bottom: 0.5rem;">Caídas pronunciadas reflejan periodos de estrés de mercado; una recuperación rápida indica mayor resiliencia.</li>
        <li style="color: #E0E0E0; margin-bottom: 0.5rem;">Si una estrategia optimizada supera de forma consistente a los benchmarks, se confirma que el modelo aporta valor frente a una inversión pasiva.</li>
    </ul>
    <p style="color: #E0E0E0; line-height: 1.8; margin-bottom: 0;">La interpretación conjunta del gráfico permite evaluar no solo cuánto se gana, sino <strong style="color: #1E88E5;">cómo se gana</strong>, identificando estrategias más robustas frente a escenarios adversos.</p>
</div>
""", unsafe_allow_html=True)
